...
// MockRPCClient simula um cliente RPC
type MockRPCClient struct {
	CallFunc func(method string, params ...interface{}) (interface{}, error)
}
...
func (m *MockRateLimiter) Middleware(action string) fiber.Handler {
	...
	// Retorna um handler que sempre passa
...
// NewMockedHandler cria um handler com todos os mocks injetados
func NewMockedHandler() (*http.NewHandler, *MockUserService, *MockAuthService, *MockTransactionService, *MockTronService) {
	...
	return handler, userMock, authMock, txMock, tronMock
}
