...
func (v *ValidatorService) Validate(data interface{}) *errors.AppError {
	...
	if _, ok := err.(*validator.InvalidValidationError); ok {
		return errors.NewInternalError("Invalid validation error", nil)
	}
	...
	return errors.NewValidationError("unknown", "Validation failed")
}
